...
LuaProc::init ()
{
	...
	// sandbox
	lua.do_command ("io = nil os = nil loadfile = nil require = nil dofile = nil select = nil package = nil load = nil rawset = nil setmetatable = nil getmetatable = nil debug = nil");
#if 0
...
LuaProc::configure_io (ChanCount in, ChanCount out)
{
	...
	// push configuration into global namespace
	lua_State* L = lua.getState ();
		...
		pframes_t nframes, framecnt_t offset)
{
	...
	try {
		...
		// TODO: re-map in/out here (rather than require lua to do it)??
