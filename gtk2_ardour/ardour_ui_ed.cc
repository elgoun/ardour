...
ARDOUR_UI::install_actions ()
{
	...
	act = ActionManager::register_action (main_actions, X_("AddLuaScript"), _("Add Lua Script"), sigc::mem_fun (*this, &ARDOUR_UI::add_lua_script));
	ActionManager::session_sensitive_actions.push_back (act);

	act = ActionManager::register_action (main_actions, X_("RemoveLuaScript"), _("Remove Lua Script"), sigc::mem_fun (*this, &ARDOUR_UI::remove_lua_script));
	ActionManager::session_sensitive_actions.push_back (act);
